...
//       try {
//         var framesY = image.planes[0].bytes;
//         var framesU = image.planes[1].bytes;
//         var framesV = image.planes[2].bytes;

//         var blah = await platform
//             .invokeMethod("REAL_TIME_PROCESSING", [framesY, framesU, framesV]);
//         var b = blah;
//       } catch (err) {
//         print(err);
//       }
